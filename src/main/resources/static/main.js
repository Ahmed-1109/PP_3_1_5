...
function showUserInfo() {
    fetch(showUser)
        ...
        .then((data) => {
            ...
            const firstNameCol = "<td>" + data.firstName + "</td>";
            const lastNameCol = "<td>" + data.lastName + "</td>";
            const emailCol = "<td>" + data.email + "</td>";
            const userRolesCol = "<td>" + userRoles + "</td>";
            const userRow = "<tr>" + idCol + firstNameCol + lastNameCol + emailCol + userRolesCol + "</tr>";
...
async function updateUser() {
    ...
    let idEdit = '#idEdit';
    let firstNameEdit = '#firstNameEdit';
    let lastNameEdit = '#lastNameEdit';
    let emailEdit = '#emailEdit';
    let passwordEdit = '#passwordEdit';
